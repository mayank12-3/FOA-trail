...
// import HowDoesItWork from '../Home/Sec1tions/HowDoesItWork';
      ...
      <div className="contact-us-container">
        ...
        <div className="banner_section">
          <Banner
            ...
            bannerText='The only man I envy is the man who has not yet been to Africa – for he has so much to look forward to.'
        ...
        <div className="wrapper" ref={this.getInTouchRef}>
          <Row className="contact-us-body">
            <Col sm="6" className="contact-us-image">
              ...
              <p>Get in touch with the Safari Expert now!</p>
              <div className="contact-details">
                <p>
                  <a href="tel:+918088942147">+91 80889 42147</a>
                </p>
                <p>
                  <a href="mailto:travel@fullofafrica.com">travel@fullofafrica.com</a>
                </p>
              </div>
            </Col>
