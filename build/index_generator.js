...
const generateIndexHtml = function () {
  ...
  <head>
    ...
    <meta name="description" content="Planing a Safari in Africa? We build iternaries for all sorts of Safaris. One of the leading Safari organizers in Kenya & Tanzania. Book your Safari now"
    />
    <link rel="apple-touch-icon" href="logo192.png" />
    <link rel="manifest" href="%PUBLIC_URL%/manifest.json" />
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap" />
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons" />
    <title>Classic Kenya Safaris - Experience Wilderness - Luxury Safaris</title>
    ${isGTMRequired && gtmID ? 
      `<script>
